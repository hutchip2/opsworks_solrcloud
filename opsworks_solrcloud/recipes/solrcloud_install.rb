...
directory '/usr/local/solr/solr/configset1' do
  owner 'root'
  group 'root'
  mode '0755'
  action :create
...
directory '/usr/local/solr/solr/configset1/conf' do
  owner 'root'
  group 'root'
  mode '0755'
  action :create
...
file '/usr/local/solr/solr/configset1/conf/schema.xml' do
...
file '/usr/local/solr/solr/configset1/conf/solrconfig.xml' do
